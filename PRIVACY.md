...
This Privacy Policy describes how your data is handled by the **Pocket Pomo** Chrome Extension (the "Extension"). 

## 1. Our Privacy Philosophy
We believe that productivity tools should respect user privacy. **Pocket Pomo is designed to be a private, local-first tool.** ## 2. Data Collection
**Pocket Pomo does not collect, store, or transmit any personal data.**
