...
function playSynthesizedSound(type: 'bell' | 'digital' | 'synth'): void {
  try {
...
chrome.runtime.onMessage.addListener((message: { action?: string; chimeType?: 'chime' | 'bell' | 'digital' | 'synth' }) => {
